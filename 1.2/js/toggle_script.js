jQuery(document).ready(function() {
    ...
    /****** color selection *****/
      jQuery('.bg_black').click(function() {
      });
      jQuery('.bg_white').click(function() {
       
      });
      jQuery('.bg_Bisque').click(function() {
       
      });
      jQuery('.bg_Aquamarine').click(function() {
      
      });
      jQuery('.bg_AntiqueWhite').click(function() {
         
      });
      jQuery('.bg_PaleGoldenRod').click(function() {
         
      });
      jQuery('.bg_yellow').click(function() {
