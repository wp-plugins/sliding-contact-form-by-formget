...
You can also display your Contact Form individually on pages, post, widgets and sidebar, by using the WordPress shortcode.
...
= Version 2.2=
* Added FormGet widget, now u can add formget form at sidebar and footer also.
